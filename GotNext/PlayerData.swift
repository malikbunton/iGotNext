...
var gameSet: [Game] = [
    Game(location: CLLocationCoordinate2D(latitude: 33.756885, longitude: -84.392111), isOpen: true, players: playerSetOne, close: "9:00PM", open: "7:OOAM"),
    Game(location: CLLocationCoordinate2D(latitude: 33.746250, longitude: -84.413865), isOpen: false, players: NSArray(), close: "10:00AM", open: "6:00AM"),
    Game(location: CLLocationCoordinate2D(latitude: 33.767309, longitude: -84.423287), isOpen: true, players: playerSetTwo, close: "12:00AM", open: "8:00AM"),
    Game(location: CLLocationCoordinate2D(latitude: 33.767309, longitude: -84.423287), isOpen: true, players: playerSetThree, close: "5:00PM", open: "8:00AM")
